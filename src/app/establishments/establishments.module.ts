...
import {EstabUpdateComponent} from './estab-update/estab-update.component';
...
@NgModule({
  declarations: [
    EstabListComponent,
    EstabCreateComponent,
    EstabShowComponent,
    EstabUpdateComponent,
    EstabConditionComponent,
    ImageCropperComponent,
    EstabContactComponent,
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    AgmCoreModule.forRoot({apiKey: 'AIzaSyCz4CqKvRe9lYpYT2_1NdVoeCqItxkhv7w'}),
  ...
  entryComponents: [RoomTypeComponent]
})
